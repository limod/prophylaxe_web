...
function RiskSituation() {
    var _counter = 0;
    var _Row = '<li><input type="text" class="form-control" value="" name="risk_situations_array[]"><button name="btnRemove" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-minus"></span></button></li>';
     ...
     */
//    _listID.find('input[name^="risk_"]').each(function(index, value) {
//        tmp = $(value).attr('name');
//        tmp = tmp.substring(41, 42);
//        if (tmp > _counter) {
//            _counter = tmp;
//        }
//    });
