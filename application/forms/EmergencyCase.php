...
class Application_Form_EmergencyCase extends Zend_Form {
    ...
    public function getRiskSituationAddButton() {
        return '<button class="btn btn-primary" type="button" id="btnRiskSituationAdd"><span class="glyphicon glyphicon-plus"></span></button>';
    }

    public function getRiskSituationRemoveButton() {
        return '<button name="btnRemove" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-minus"></span></button>';
    }

    public function getHelpPersonAddButton() {
        return '<button class="btn btn-primary" type="button" id="btnHelpPersonAdd"><span class="glyphicon glyphicon-plus"></span></button>';
    }

    public function getHelpPersonRemoveButton() {
        return '<button name="btnRemove" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-minus"></span></button>';
    }

    public function getSafetyThoughtAddButton() {
        return '<button class="btn btn-primary" type="button" id="btnSafetyThoughtAdd"><span class="glyphicon glyphicon-plus"></span></button>';
    }

    public function getSafetyThoughtRemoveButton() {
        return '<button name="btnRemove" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-minus"></span></button>';
    }

    public function getSafetyActionAddButton() {
        return '<button class="btn btn-primary" type="button" id="btnSafetyActionAdd"><span class="glyphicon glyphicon-plus"></span></button>';
    }

    public function getSafetyActionRemoveButton() {
        return '<button name="btnRemove" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-minus"></span></button>';
    }

    public function getLimitRelapseAddButton() {
        return '<button class="btn btn-primary" type="button" id="btnLimitRelapseAdd"><span class="glyphicon glyphicon-plus"></span></button>';
    }
